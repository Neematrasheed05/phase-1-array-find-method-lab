const record = [
  ...
  function superbowlWin(records) {
    // Use the find method to search for a record with a "W" result
    const winRecord = records.find(record => record.result === "W" && record.year === "2015" );
...
console.log(result); // It should print "2015" or undefined
